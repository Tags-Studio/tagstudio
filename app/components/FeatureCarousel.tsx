...
const features = [
  {
    ...
    description:
      "هوية بصرية تخلي عميلك يميّزك من أول نظرة ويفتكرك قبل منافسك — نظام متكامل جاهز يشتغل على كل نقاط التواصل بشكل موحّد.",
  ...
  },
  {
    ...
    description:
      "محتوى بصري يخلي صفحتك تبان احترافية وتزوّد تفاعل عملائك معاك من أول سكرول.",
  ...
  },
  {
    ...
    description:
      "مطبوعات جاهزة تسلّمها لعميلك أو تستخدمها في اجتماعاتك من غير أي تعديل.",
  ...
  },
  {
    ...
    description:
      "فيديو بيشرح فكرتك في ثواني ويخلي عميلك يفهمك من غير مجهود.",
