...
export const metadata: Metadata = {
  title: "الأسئلة الشائعة عن تصميم الهوية البصرية",
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-b from-secondary/30 via-background to-background border-b border-border">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-6">
            مرحباً بك في صفحة الأسئلة الشائعة لـ <strong className="text-primary font-semibold">تاج ستوديو</strong>. قمنا هنا بجمع وإجابة أكثر الأسئلة التي يطرحها عملاؤنا في المملكة العربية السعودية ومصر حول خدمات تصميم الشعارات، الهويات البصرية، المطبوعات، السوشيال ميديا، وفيديو الموشن جرافيك.
          </p>
          <p className="text-base sm:text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed text-justify mb-6">
            نحن ندرك تماماً أن اتخاذ قرار الاستثمار في بناء علامة تجارية أو إعادة هيكلة هوية بصرية (Rebranding) لشركتك، عيادتك، أو مطعمك ليس قراراً عابراً. السوق في الرياض، جدة، والقاهرة يشهد تنافسية غير مسبوقة، والعميل اليوم يتخذ قرار الشراء بناءً على "الثقة البصرية" التي يراها في اللحظات الأولى. لذلك، صممنا هذا الدليل الشامل ليكون مرجعك الموثوق قبل اتخاذ أي خطوة. سواء كنت تتساءل عن الفرق بين الشعار البسيط والهوية المتكاملة، أو ترغب في معرفة تفاصيل الباقات والأسعار، أو تبحث عن آلية عملنا وكيف نضمن لك حقوقك القانونية والملكية الفكرية؛ ستجد إجابات شفافة ومباشرة هنا. 
          </p>
          <p className="text-base sm:text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed text-justify">
            هدفنا في تاج ستوديو ليس مجرد تسليم ملفات تصميم، بل بناء "نظام بصري" متكامل يعمل كأصل من أصول شركتك، يزيد من قيمة خدماتك، ويسهل على فريق التسويق الخاص بك تحقيق أهداف المبيعات. ندعوك لقراءة هذه الإجابات، وإذا كان لديك أي استفسار خاص بحالة مشروعك، فإن فريقنا من المستشارين الإبداعيين متواجد دائماً لتقديم استشارة مجانية مخصصة لك عبر الواتساب.
          </p>
        </div>
      </section>
