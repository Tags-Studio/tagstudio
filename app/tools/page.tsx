...
const TOOLS = [
  ...
  },
  {
    ...
    badge: 'new',
    color: '#006C35',
    colorDim: 'rgba(0,108,53,0.08)',
    icon: 'fas fa-flag',
    url: '/tools/saudi-national-day-96-identity',
    features: ['شعار PNG مفرغ وفيكتور AI', 'دليل الهوية الرسمي PDF', '8 خطوط من وزارة الثقافة', 'رسومات تلوين وكراسة أنشطة']
  },
  {
