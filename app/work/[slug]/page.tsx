  ...
  return (
    <main className="bg-[#f6f1e8] text-[#273127]">
      ...
      <section className="mx-auto grid max-w-[1500px] gap-px px-4 pb-px sm:px-6 lg:grid-cols-3 lg:px-8">
        <article className="overflow-hidden bg-[#fbf8f1] lg:col-span-3">
          <div className="grid items-stretch lg:grid-cols-[0.78fr_1.22fr]">
            <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
              ...
              <p className="mt-7 text-lg leading-9 text-[#697166]">
                انطلقت فكرة الشعار من اسم العلامة نفسه، فتم البحث عن رابط بصري
                يجمع بين مكوّنين مألوفين في المطبخ العربي: أوراق الزعتر وحبة
                السمسم. الهدف لم يكن رسم المكوّنين بشكل مباشر، بل اختزالهما في
                رمز بسيط يحمل روح المنتج ويسهل تذكّره.
              </p>

              <div className="mt-9 space-y-6">
                <div className="border-r-4 border-[#a8b51d] pr-5">
                  <h3 className="text-lg font-bold text-[#8f9d10]">
                    ورقة الزعتر
                  </h3>
                  <p className="mt-2 leading-8 text-[#697166]">
                    منحت الرمز اتجاهه العضوي وإحساسه بالطبيعة والطزاجة، كما
                    عبّرت عن المكوّن الأساسي المرتبط باسم العلامة.
                  </p>
                </div>

                <div className="border-r-4 border-[#d39b51] pr-5">
                  <h3 className="text-lg font-bold text-[#b27b38]">
                    حبة السمسم
                  </h3>
                  <p className="mt-2 leading-8 text-[#697166]">
                    أضافت الشكل الداخلي الناعم والإحساس بالدفء والمخبوزات،
                    وربطت الرمز بصريًا بالمنتجات التي تقدمها العلامة.
                  </p>
                </div>

                <div className="border-r-4 border-[#59645f] pr-5">
                  <h3 className="text-lg font-bold text-[#4f5a55]">
                    الرمز النهائي
                  </h3>
                  <p className="mt-2 leading-8 text-[#697166]">
                    نتج عن الدمج شكل متوازن يمكن قراءته كورقة نبات أو حبة
                    طبيعية في الوقت نفسه، ليعمل منفردًا كأيقونة أو بجوار الاسم
                    العربي والإنجليزي دون فقدان وضوحه.
                  </p>
                </div>
              </div>

              <p className="mt-10 rounded-2xl bg-[#eef0d6] p-6 leading-8 text-[#4f584d]">
                يعكس الرمز وعد العلامة: مكونات طبيعية، نكهة أصيلة، وتجربة
                معاصرة. لذلك تم تصميمه ليظل واضحًا على العبوات والملابس
                والواجهات والمحتوى الرقمي بمقاسات مختلفة.
              </p>
            </div>

            <div className="relative min-h-[620px] border-t border-black/5 bg-white lg:min-h-[820px] lg:border-r lg:border-t-0">
              <Image
                src="/images/zaatar-logo-concept-explanation.jpg"
                alt="شرح الفكرة الإبداعية لشعار زعتر وسمسم المستوحى من ورقة الزعتر وحبة السمسم"
                fill
