...
article_path = r"C:\Users\zahran\.gemini\antigravity\brain\96008217-4abb-4027-acf1-505921affcc3\all_blog_articles_md\011_afdal-amthilat-huwiyat-basariya-saudia_HUMANIZED_SEO_v3.md"
...
# Locate post 11 boundaries (0-indexed)
start_idx = None
end_idx = None
for idx, line in enumerate(lines):
    if 'id: "11"' in line and start_idx is None:
        ...
        while i >= 0:
            if '{' in lines[i]:
                ...
                break
            i -= 1
    if 'id: "12"' in line and end_idx is None:
...
if start_idx is None or end_idx is None:
    raise ValueError(f"Could not locate post 11 boundaries. start_idx={start_idx}, end_idx={end_idx}")
