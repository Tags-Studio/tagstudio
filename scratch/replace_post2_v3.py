...
article_path = r"C:\Users\zahran\.gemini\antigravity\brain\96008217-4abb-4027-acf1-505921affcc3\all_blog_articles_md\002_intaj-al-video-wal-motion-graphic-fi-al-taswiq-al-hadith_EXPANDED_SEO_v3.md"
...
# Locate post 2 boundaries (0-indexed)
start_idx = None
end_idx = None
for idx, line in enumerate(lines):
    if 'id: "2"' in line and start_idx is None:
        ...
        while i >= 0:
            if '{' in lines[i]:
                ...
                break
            i -= 1
    if 'id: "3"' in line and end_idx is None:
...
if start_idx is None or end_idx is None:
    raise ValueError(f"Could not locate post 2 boundaries. start_idx={start_idx}, end_idx={end_idx}")
